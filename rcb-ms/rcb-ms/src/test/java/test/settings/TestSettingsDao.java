...
public void addSettings(){
	...
	SettingsDao dao=
	context.getBean("settingsDao",SettingsDao.class);
	Settings sett = new Settings("hse", "中文t", "127.0.0.1", "io55", "长方", "孙膑", 65655, 7777777, 556565, 1234567, "123@qq.com", "5466", "我是内容，风景不错");
...
public void modifySettings(){
	...
	SettingsDao dao=
	context.getBean("settingsDao",SettingsDao.class);
	Settings sett =dao.findSettingsById("1");
	sett.setTitle("合伙人");
	sett.setPhone(123456);
	dao.modifySettings(sett);
