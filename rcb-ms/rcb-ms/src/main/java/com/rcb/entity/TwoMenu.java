...
public class TwoMenu implements Serializable {
	...
	private static final long serialVersionUID = -8012003788348959388L;
	...
	public TwoMenu(String id, String oneMenuId, String title, String thumb, String content, int seq, int isshow,
			String intro) {
		super();
		this.id = id;
	...
	public String toString() {
		return "TwoMenu [id=" + id + ", oneMenuId=" + oneMenuId + ", title=" + title + ", thumb=" + thumb + ", content="
				+ content + ", seq=" + seq + ", isshow=" + isshow + ", intro=" + intro + "]";
	}
