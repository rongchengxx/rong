...
public class SinglePage implements Serializable {
	...
	public SinglePage(String id, String oneMenuId, String twoMenuId, String title, String picture, String narration,
			String content, String keyWord, String keyWordTitle, String keyWordDesc, int seq, Timestamp createTime,
			 String author, int clicks, int isshow) {
		super();
		this.id = id;
	...
	public String toString() {
		return "SinglePage [id=" + id + ", oneMenuId=" + oneMenuId + ", twoMenuId=" + twoMenuId + ", title=" + title
				+ ", picture=" + picture + ", narration=" + narration + ", content=" + content + ", keyWord=" + keyWord
				+ ", keyWordTitle=" + keyWordTitle + ", keyWordDesc=" + keyWordDesc + ", seq=" + seq + ", createTime="
				+ createTime + ", author=" + author + ", clicks=" + clicks + ", isshow="
				+ isshow + "]";
	}
	public String getId() {
		return id;
